...
interface ComponentProps extends React.ComponentPropsWithoutRef<'canvas'> {
...
export const SpotlightCursor = ({
  ...
  className = "",
  ...rest
}: { config?: SpotlightConfig; className?: string } & React.CanvasHTMLAttributes<HTMLCanvasElement>) => {
