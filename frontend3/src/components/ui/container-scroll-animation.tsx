...
export const ContainerScroll = ({
  ...
  const translate = useTransform(scrollYProgress, [0, 0.3], [0, -20]);
...
export const Card = ({
  ...
  return (
    <motion.div
      ...
      className="max-w-7xl mx-auto h-[50rem] md:h-[58rem] w-full border-4 border-[#6C6C6C] p-2 md:p-6 bg-[#222222] rounded-[30px] shadow-2xl"
    >
