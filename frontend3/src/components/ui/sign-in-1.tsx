  ...
  (
    ...
    return (
      <div className={cn("flex flex-col items-center justify-center", className)}>
        ...
        {/* Footer */}
        {footerContent && (
          <div className="mt-6 w-full max-w-xl px-8 text-center text-sm text-muted-foreground animate-in fade-in-0 zoom-in-95 slide-in-from-bottom-4 duration-500 [animation-delay:200ms]">
            {footerContent}
          </div>
        )}
      </div>
